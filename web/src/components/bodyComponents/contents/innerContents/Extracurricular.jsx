    ...
    return (
        <>
            <div className = "pl-5 pr-5 pt-3 pb-3 flex flex-col items-center justify-center gap-5">
                <h1 className = "text-[1.7rem] lg:text-[3.5vw] md:text-[3.9vw] text-center font-semibold">Extracurriculars</h1>
                <div className = "mt-[3rem] p-[3rem] exp-block rounded-2xl">
                    <h2 className = "mt-[1rem] text-[1.5rem] lg:text-[3vw] md:text-[3.5vw] font-medium">BizTech UBC Hackathon</h2>
                    <h2 className = "text-[1rem] lg:text-[2vw] md:text-[2.3vw] font-base">Team Leader | October, 2024</h2>
                ...
                <div className = "mt-[3rem] p-[3rem] rounded-2xl">
                    <h2 className = "mt-[1rem] text-[1.5rem] lg:text-[3vw] md:text-[3.5vw] font-medium">Etsy</h2>
                    <h2 className = "text-[1rem] lg:text-[2vw] md:text-[2.3vw] font-base">Small Business Owner | May, 2024 - Sep, 2024</h2>
                ...
                <div className = "mt-[3rem] p-[3rem] exp-block rounded-2xl">
                    <h2 className = "mt-[1rem] text-[1.5rem] lg:text-[3vw] md:text-[3.5vw] font-medium">Bilignma</h2>
                    <h2 className = "text-[1rem] lg:text-[2vw] md:text-[2.3vw] font-base">YouTube Content Creator | Aug, 2024 - present</h2>
